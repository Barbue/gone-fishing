...
if(action === 'C'){
   ...
   console.log(`\n You chose to keep the ${fish.name}!\n`);
    ...
    while(action === "Fish2" && caughtFish.length < 2 ||  action === "Fish3" && caughtFish.length < 3 || action === "Fish4" && caughtFish.length < 4 || action === "Fish5" && caughtFish.length < 5){console.log('You have yet to catch that many fish. Please choose an option that corresponds to a caught fish. Alternatively, choose [F] to cancel RR');
        action = prompt(`> `);
    }
    ...
    }else if(action === 'Fish2'){
        caughtFish.splice(1,1);
        console.log(`\n You rereleased the chosen fish!\n`);
    }else if(action === 'Fish3'){
        caughtFish.splice(2,1);
        console.log(`\n You rereleased the chosen fish!\n`);
    }else if(action === 'Fish4'){
        caughtFish.splice(3,1);
        console.log(`\n You rereleased the chosen fish!\n`);
    }else if(action === 'Fish5'){
